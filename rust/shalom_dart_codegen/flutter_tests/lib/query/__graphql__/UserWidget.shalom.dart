...
class UserWidgetResponse   {
    ...
    // keywordargs constructor
     UserWidgetResponse(
        ...
        static UserWidgetResponse fromResponse(shalom_core.JsonObject data, { UserWidgetVariables? variables }){
    ...
    int get hashCode =>
        ...
        UserWidgetResponse.G__typename
        ]);
    ...
    static UserWidgetResponse fromJson(shalom_core.JsonObject data) {
        final UserWidget_user? user$value = 
...
;
    ...
    @override
    bool operator ==(Object other) {
        return identical(this, other) || (other is UserWidgetVariables
