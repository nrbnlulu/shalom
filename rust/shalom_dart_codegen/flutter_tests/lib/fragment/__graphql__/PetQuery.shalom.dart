...
class PetQueryResponse   {
    ...
    static PetQueryResponse fromJson(shalom_core.JsonObject data) {
     ...
     pet$value = 
            ...
            data['pet'] == null ? null : PetWidgetRef.fromInput(shalom_core.observedRefInputFromJson((data['pet'] as shalom_core.JsonObject)[r'$PetWidget'] as shalom_core.JsonObject))
