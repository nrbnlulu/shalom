...
extension type PetWidgetRef.fromInput(shalom_core.ObservedRefInput _inner) {
  ...
  Future<PetWidgetData?> readFrom(shalom_core.CacheProxy cache) async {
    return await cache.readFragment<PetWidgetData>(
      fragmentName: fragmentName,
      entityKey: anchor,
      bridgeDecoder: PetWidgetData.fromShalomValue,
    );
  }

  Stream<shalom_core.GraphQLResponse<PetWidgetData>> observe(
