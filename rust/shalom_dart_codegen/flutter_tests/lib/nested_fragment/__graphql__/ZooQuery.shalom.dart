...
class ZooQueryResponse   {
    ...
    static ZooQueryResponse fromJson(shalom_core.JsonObject data) {
     ...
     zoo$value = 
            ...
            data['zoo'] == null ? null : ZooWidgetRef.fromInput(shalom_core.observedRefInputFromJson((data['zoo'] as shalom_core.JsonObject)[r'$ZooWidget'] as shalom_core.JsonObject))
        
    
;
        return ZooQueryResponse(
...
;
    ...
    @override
    bool operator ==(Object other) {
        return identical(this, other) || (other is ZooQueryVariables
