...
class AnimalQueryResponse   {
    ...
    static AnimalQueryResponse fromJson(shalom_core.JsonObject data) {
     ...
     animal$value = 
            ...
            data['animal'] == null ? null : AnimalWidgetRef.fromInput(shalom_core.observedRefInputFromJson((data['animal'] as shalom_core.JsonObject)[r'$AnimalWidget'] as shalom_core.JsonObject))
