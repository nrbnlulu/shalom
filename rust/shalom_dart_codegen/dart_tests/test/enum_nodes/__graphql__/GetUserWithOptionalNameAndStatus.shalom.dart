...
class GetUserWithOptionalNameAndStatusResponse {
    ...
    GetUserWithOptionalNameAndStatusResponse({
    ...
    static GetUserWithOptionalNameAndStatusResponse fromJson(JsonObject data, {ShalomContext? context}) {
        ...
        userOptional_value = 
            ...
            userOptional$raw == null ? null : GetUserWithOptionalNameAndStatus_userOptional.fromJson(userOptional$raw, context: context)
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    static GetUserWithOptionalNameAndStatus_userOptional fromJson(JsonObject data, {ShalomContext? context}) {
