...
class GetUserWithStatusResponse {
    ...
    static GetUserWithStatusResponse fromJson(JsonObject data, {ShalomContext? context}) {
        ...
        user_value = 
            ...
            user$raw == null ? null : GetUserWithStatus_user.fromJson(user$raw, context: context)
         
    
;
    
    return GetUserWithStatusResponse(
    ...
    (other is GetUserWithStatusResponse &&
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    static GetUserWithStatus_user fromJson(JsonObject data, {ShalomContext? context}) {
