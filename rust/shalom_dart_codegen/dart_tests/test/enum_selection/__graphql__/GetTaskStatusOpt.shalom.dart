...
class GetTaskStatusOptResponse {
    ...
    static GetTaskStatusOptResponse fromJson(JsonObject data, ShalomContext? context) {
        ...
        task_value = 
                ...
                GetTaskStatusOpt_task.fromJson(task$raw, context)
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    static GetTaskStatusOpt_task fromJson(JsonObject data, ShalomContext? context) {
