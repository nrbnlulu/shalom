...
void main() {
  group('Fragment Basic Functionality', () {
    ...
    test('fragmentOptional - Post fragment basic functionality', () {
      ...
      final result = GetPostResponse.fromResponse(
        postData,
        variables: variables,
      );
    ...
    test(
      ...
      () {
        ...
        final result = GetPostWithAuthorResponse.fromResponse(
          postData,
          variables: variables,
        );
    ...
    test(
      ...
      () {
        ...
        final result = GetPostWithMetaResponse.fromResponse(
          postData,
          ctx: ctx,
          variables: variables,
        );
    ...
    test(
      ...
      () {
        ...
        final getUserResult = GetUserResponse.fromResponse(
          userData,
          variables: getUserVars,
        );

        final getUserWithAuthorVars = GetUserWithAuthorVariables(
          userId: "user1",
        );
    ...
    test(
      ...
      () {
        ...
        final result = GetUserWithAuthorResponse.fromResponse(
          userData,
          variables: variables,
        );
  ...
  group('Fragment Cache Normalization', () {
    ...
    test(
      ...
      () {
        ...
        final ctx = ShalomCtx.withCapacity();
        final variables = GetPostVariables(postId: "post1");
        final result1 = GetPostResponse.fromResponse(
          postData,
          ctx: ctx,
          variables: variables,
        );
    ...
    test(
      ...
      () {
        ...
        final ctx = ShalomCtx.withCapacity();
        final variables = GetPostWithAuthorVariables(postId: "post1");
        final result1 = GetPostWithAuthorResponse.fromResponse(
          postData,
          ctx: ctx,
          variables: variables,
        );
        ...
        GetPostWithAuthorResponse.fromResponse(
          updatedData,
          ctx: ctx,
          variables: variables,
        );
    ...
    test(
      ...
      () {
        ...
        final ctx = ShalomCtx.withCapacity();
        final variables = GetPostWithMetaVariables(postId: "post1");
        final result1 = GetPostWithMetaResponse.fromResponse(
          postData1,
          ctx: ctx,
          variables: variables,
        );
        ...
        GetPostWithMetaResponse.fromResponse(
          postData2,
          ctx: ctx,
          variables: variables,
        );
