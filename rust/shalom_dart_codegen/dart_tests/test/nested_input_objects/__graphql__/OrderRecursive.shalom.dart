...
class OrderRecursiveResponse {
    ...
    static OrderRecursiveResponse fromJson(JsonObject data, ShalomContext? context) {
        ...
        orderRecursive_value = 
                ...
                orderRecursive$raw == null ? null : OrderRecursive_orderRecursive.fromJson(orderRecursive$raw, context)
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    static OrderRecursive_orderRecursive fromJson(JsonObject data, ShalomContext? context) {
