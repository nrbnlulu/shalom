...
class InputScalarListOptionalResponse {
    ...
    static InputScalarListOptionalResponse fromJson(JsonObject data, ShalomContext? context) {
        ...
        InputScalarListOptional_value = 
            ...
            InputScalarListOptional$raw == null ? null : InputScalarListOptional_InputScalarListOptional.fromJson(InputScalarListOptional$raw, context)
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    static InputScalarListOptional_InputScalarListOptional fromJson(JsonObject data, ShalomContext? context) {
