...
class InputScalarListMaybeResponse {
    ...
    static InputScalarListMaybeResponse fromJson(JsonObject data, ShalomContext? context) {
        ...
        InputScalarListMaybe_value = 
                ...
                InputScalarListMaybe$raw == null ? null : InputScalarListMaybe_InputScalarListMaybe.fromJson(InputScalarListMaybe$raw, context)
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    static InputScalarListMaybe_InputScalarListMaybe fromJson(JsonObject data, ShalomContext? context) {
