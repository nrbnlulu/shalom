...
class InputScalarListRequiredResponse {
    ...
    /// class members
        ...
        InputScalarListRequired_InputScalarListRequired? InputScalarListRequired;
    ...
    static InputScalarListRequiredResponse fromJson(JsonObject data, ShalomContext? context) {
        ...
        InputScalarListRequired_value = 
            ...
            InputScalarListRequired$raw == null ? null : InputScalarListRequired_InputScalarListRequired.fromJson(InputScalarListRequired$raw, context)
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    static InputScalarListRequired_InputScalarListRequired fromJson(JsonObject data, ShalomContext? context) {
