...
class ListOfScalarsOptionalResponse {
    ...
    ListOfScalarsOptionalResponse({
    
        this.listOfScalarsOptional,
    
    });
    static ListOfScalarsOptionalResponse fromJson(JsonObject data, ShalomContext? context) {
        ...
        listOfScalarsOptional_value = 
            ...
            listOfScalarsOptional$raw == null ? null : (listOfScalarsOptional$raw as List<dynamic>).map((e) => 
...
;
    ...
    (other is ListOfScalarsOptionalResponse &&
        ...
        const ListEquality().equals(other.listOfScalarsOptional, listOfScalarsOptional)
    ...
    int get hashCode =>
        ...
        listOfScalarsOptional.hashCode;
    ...
    return {
        ...
        'listOfScalarsOptional':
            ...
            this.listOfScalarsOptional?.map((e) => 
