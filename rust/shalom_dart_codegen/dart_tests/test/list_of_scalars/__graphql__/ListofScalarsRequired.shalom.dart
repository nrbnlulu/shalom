...
class ListofScalarsRequiredResponse {
    ...
    ListofScalarsRequiredResponse({
    required
        this.listOfScalarsRequired,
    
    });
    static ListofScalarsRequiredResponse fromJson(JsonObject data, ShalomContext? context) {
        ...
        listOfScalarsRequired_value = 
            ...
            (listOfScalarsRequired$raw as List<dynamic>).map((e) => 
...
;
    ...
    (other is ListofScalarsRequiredResponse &&
        ...
        const ListEquality().equals(other.listOfScalarsRequired, listOfScalarsRequired)
    ...
    int get hashCode =>
        ...
        listOfScalarsRequired.hashCode;
    ...
    return {
        ...
        'listOfScalarsRequired':
            ...
            this.listOfScalarsRequired.map((e) => 
