...
(
 ...
 updateWithJson(Map<String , dynamic> data) {
            ...
            listingOpt_value = GetListingOptListingOpt.fromJson(listingOpt_raw as Map<String , dynamic>);
            } else {
...
(
 ...
 &&
    ...
    GetListingOptListingOpt updateWithJson(Map<String , dynamic> data) {
            ...
            user_value = GetListingOptUser.fromJson(user_raw as Map<String , dynamic>);
            } else {
