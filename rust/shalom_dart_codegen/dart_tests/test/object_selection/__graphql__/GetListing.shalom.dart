...
class RequestGetListing {
  ...
  /// Creates from JSON
  factory RequestGetListing.fromJson(Map<String, dynamic> json) => RequestGetListing(
    
    listing: 
      json['listing'] != null 
        ? RequestGetListingListing.fromJson(json['listing'] as Map<String, dynamic>)
        : null
    ,
    ...
    return RequestGetListing(
      ...
      listing: 
        data.containsKey('listing') 
          ? (data['listing'] != null 
              ? RequestGetListingListing.fromJson(data['listing'] as Map<String, dynamic>)
              : null)
          : this.listing
      ,
...
class RequestGetListingListing {
  ...
  /// Creates from JSON
  factory RequestGetListingListing.fromJson(Map<String, dynamic> json) => RequestGetListingListing(
    ...
    user: 
      json['user'] != null 
        ? RequestGetListingUser.fromJson(json['user'] as Map<String, dynamic>)
        : null
    ,
    ...
    return RequestGetListingListing(
      ...
      user: 
        data.containsKey('user') 
          ? (data['user'] != null 
              ? RequestGetListingUser.fromJson(data['user'] as Map<String, dynamic>)
              : null)
          : this.user
      ,
...
class RequestGetListingUser {
  ...
  /// Creates from JSON
  factory RequestGetListingUser.fromJson(Map<String, dynamic> json) => RequestGetListingUser(
