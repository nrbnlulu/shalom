...
class InputCustomScalarListInsideInputObjectResponse{
    ...
    static InputCustomScalarListInsideInputObjectResponse fromJson(JsonObject data) {
        ...
        final InputCustomScalarListInsideInputObject_InputCustomScalarListInsideInputObject? InputCustomScalarListInsideInputObject_value;
        
            InputCustomScalarListInsideInputObject_value = 
    
        
            data["InputCustomScalarListInsideInputObject"] == null ? null : InputCustomScalarListInsideInputObject_InputCustomScalarListInsideInputObject.fromJson(data["InputCustomScalarListInsideInputObject"])
...
;
    ...
    InputCustomScalarListInsideInputObjectResponse updateWithJson(JsonObject data) {
...
;
            ...
            InputCustomScalarListInsideInputObject_value = InputCustomScalarListInsideInputObject;
        }
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    static InputCustomScalarListInsideInputObject_InputCustomScalarListInsideInputObject fromJson(JsonObject data) {
...
;
    ...
    InputCustomScalarListInsideInputObject_InputCustomScalarListInsideInputObject updateWithJson(JsonObject data) {
