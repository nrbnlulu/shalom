...
class InputCustomScalarListMaybeResponse{
    ...
    static InputCustomScalarListMaybeResponse fromJson(JsonObject data) {
        ...
        final InputCustomScalarListMaybe_InputCustomScalarListMaybe? InputCustomScalarListMaybe_value;
            ...
            data["InputCustomScalarListMaybe"] == null ? null : InputCustomScalarListMaybe_InputCustomScalarListMaybe.fromJson(data["InputCustomScalarListMaybe"])
...
;
    ...
    InputCustomScalarListMaybe_InputCustomScalarListMaybe updateWithJson(JsonObject data) {
