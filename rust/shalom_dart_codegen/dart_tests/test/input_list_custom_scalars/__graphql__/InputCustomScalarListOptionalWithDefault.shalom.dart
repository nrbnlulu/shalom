...
class InputCustomScalarListOptionalWithDefaultResponse {
    ...
    InputCustomScalarListOptionalWithDefaultResponse({
        ...
        InputCustomScalarListOptionalWithDefaultResponse updateWithJson(JsonObject data) {
            ...
            InputCustomScalarListOptionalWithDefault$raw == null ? null : InputCustomScalarListOptionalWithDefault_InputCustomScalarListOptionalWithDefault.fromJson(InputCustomScalarListOptionalWithDefault$raw)
