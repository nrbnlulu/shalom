...
class OptionalWithSomeDefaultResponse {
    ...
    static OptionalWithSomeDefaultResponse fromJson(JsonObject data, ShalomContext? context) {
        ...
        task_value = 
            ...
            task$raw == null ? null : OptionalWithSomeDefault_task.fromJson(task$raw, context)
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    static OptionalWithSomeDefault_task fromJson(JsonObject data, ShalomContext? context) {
