...
class UpdateUserResponse {
  ...
  static UpdateUserResponse fromJson(JsonObject data) {
    ...
    return UpdateUserResponse(updateUser: updateUser_value);
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other is UpdateUserResponse && other.updateUser == updateUser);
  }
...
class UpdateUser_updateUser {
  ...
  // keywordargs constructor
  UpdateUser_updateUser({this.email, this.name, this.phone});
...
class RequestUpdateUser extends Requestable {
  ...
  RequestUpdateUser({required this.variables});
...
class UpdateUserVariables {
  ...
  final bool phoneIsIncluded;

  UpdateUserVariables({this.phone, required this.phoneIsIncluded});
  ...
  static UpdateUserVariables fromJson(JsonObject data) {
    final String? phone_value;

    final bool phoneIsIncludedValue;
    if (data.containsKey('phone')) {
      phone_value = data['phone'];
      phoneIsIncludedValue = true;
    } else {
      phone_value = null;
      phoneIsIncludedValue = false;
    }

    return UpdateUserVariables(
      phoneIsIncluded: phoneIsIncludedValue,
