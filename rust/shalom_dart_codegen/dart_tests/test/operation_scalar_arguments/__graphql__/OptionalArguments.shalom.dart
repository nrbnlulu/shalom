...
class OptionalArgumentsResponse {
    ...
    static OptionalArgumentsResponse fromJson(JsonObject data, ShalomContext? context) {
        ...
        updateUser_value = 
                ...
                updateUser$raw == null ? null : OptionalArguments_updateUser.fromJson(updateUser$raw, context)
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    static OptionalArguments_updateUser fromJson(JsonObject data, ShalomContext? context) {
