...
class UpdatePointCoordsOptResponse{
    ...
    static UpdatePointCoordsOptResponse fromJson(JsonObject data) {
            ...
            final UpdatePointCoordsOpt_getPointById? getPointById_value;
                ...
                if (getPointById$raw != null) {
                    getPointById_value = UpdatePointCoordsOpt_getPointById.fromJson(getPointById$raw);
                } else {
    ...
    return UpdatePointCoordsOptResponse(
        ...
        getPointById: getPointById_value,
...
class UpdatePointCoordsOptVariables {
    ...
    JsonObject toJson() {
        JsonObject data = {};
                ...
                data["coords"] = coords == null ? null : rmhlxei.pointScalarImpl.serialize(coords!);
...
class UpdatePointCoordsOptNode extends Node {
  UpdatePointCoordsOptResponse? obj = null;
  UpdatePointCoordsOptNode({required super.id});

  @override 
  void updateStoreWithRaw(JsonObject raw, NodeManager manager) {
     if (obj != null) {
      obj = UpdatePointCoordsOptResponse.fromJson(raw);
  ...
  void convertToObjAndSet(JsonObject data) {
     obj = UpdatePointCoordsOptResponse.fromJson(data);
  }
