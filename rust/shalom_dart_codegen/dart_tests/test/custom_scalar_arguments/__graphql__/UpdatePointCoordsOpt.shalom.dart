...
class UpdatePointCoordsOptResponse {
    ...
    static UpdatePointCoordsOptResponse fromJson(JsonObject data, ShalomContext? context) {
        ...
        getPointById_value = 
                ...
                getPointById$raw == null ? null : UpdatePointCoordsOpt_getPointById.fromJson(getPointById$raw, context)
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    static UpdatePointCoordsOpt_getPointById fromJson(JsonObject data, ShalomContext? context) {
