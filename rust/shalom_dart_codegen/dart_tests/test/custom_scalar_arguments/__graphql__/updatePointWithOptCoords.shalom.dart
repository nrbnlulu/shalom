...
class updatePointWithOptCoordsResponse{
    ...
    /// class members
            ...
            final String updatePointWithOptCoords_id;   
    ...
    static updatePointWithOptCoordsResponse fromJson(JsonObject data) {
            ...
            final updatePointWithOptCoords_updatePointWithOptCoords? updatePointWithOptCoords_value;
                ...
                final JsonObject? updatePointWithOptCoords$raw = data['updatePointWithOptCoords']; 
                if (updatePointWithOptCoords$raw != null) {
                    updatePointWithOptCoords_value = updatePointWithOptCoords_updatePointWithOptCoords.fromJson(updatePointWithOptCoords$raw);
                } else {
    ...
    return {
        ...
        'updatePointWithOptCoords':
                ...
                updatePointWithOptCoords?.toJson()
...
class updatePointWithOptCoordsNode extends Node {
  updatePointWithOptCoordsResponse? obj = null;
  updatePointWithOptCoordsNode({required super.id});

  @override 
  void updateStoreWithRaw(JsonObject raw, NodeManager manager) {
     if (obj != null) {
      obj = updatePointWithOptCoordsResponse.fromJson(raw);
  ...
  void convertToObjAndSet(JsonObject data) {
     obj = updatePointWithOptCoordsResponse.fromJson(data);
  }
