...
class UpdatePointCoordsNonNullResponse{
    ...
    /// class members
            ...
            final String updatePointCoords_id;   
    ...
    static UpdatePointCoordsNonNullResponse fromJson(JsonObject data) {
            ...
            final UpdatePointCoordsNonNull_updatePointCoords? updatePointCoords_value;
                ...
                if (updatePointCoords$raw != null) {
                    updatePointCoords_value = UpdatePointCoordsNonNull_updatePointCoords.fromJson(updatePointCoords$raw);
                } else {
...
class UpdatePointCoordsNonNullNode extends Node {
  UpdatePointCoordsNonNullResponse? obj = null;
  UpdatePointCoordsNonNullNode({required super.id});

  @override 
  void updateStoreWithRaw(JsonObject raw, NodeManager manager) {
     if (obj != null) {
      obj = UpdatePointCoordsNonNullResponse.fromJson(raw);
  ...
  void convertToObjAndSet(JsonObject data) {
     obj = UpdatePointCoordsNonNullResponse.fromJson(data);
  }
