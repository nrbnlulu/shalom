...
class UpdatePointWithInputNonNullResponse{
    ...
    /// class members
            ...
            final String updatePointWithInput_id;   
    ...
    static UpdatePointWithInputNonNullResponse fromJson(JsonObject data) {
            ...
            final UpdatePointWithInputNonNull_updatePointWithInput? updatePointWithInput_value;
                ...
                if (updatePointWithInput$raw != null) {
                    updatePointWithInput_value = UpdatePointWithInputNonNull_updatePointWithInput.fromJson(updatePointWithInput$raw);
                } else {
...
class UpdatePointWithInputNonNullNode extends Node {
  UpdatePointWithInputNonNullResponse? obj = null;
  UpdatePointWithInputNonNullNode({required super.id});

  @override 
  void updateStoreWithRaw(JsonObject raw, NodeManager manager) {
     if (obj != null) {
      obj = UpdatePointWithInputNonNullResponse.fromJson(raw);
  ...
  void convertToObjAndSet(JsonObject data) {
     obj = UpdatePointWithInputNonNullResponse.fromJson(data);
  }
