...
class EnumInputObjectRequiredResponse {
    ...
    static EnumInputObjectRequiredResponse fromJson(JsonObject data, ShalomContext? context) {
        ...
        updateOrder_value = 
                ...
                updateOrder$raw == null ? null : EnumInputObjectRequired_updateOrder.fromJson(updateOrder$raw, context)
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    static EnumInputObjectRequired_updateOrder fromJson(JsonObject data, ShalomContext? context) {
