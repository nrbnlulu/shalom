...
class EnumWithDefaultValueResponse {
    ...
    static EnumWithDefaultValueResponse fromJson(JsonObject data, ShalomContext? context) {
        ...
        getOrderByStatus_value = 
            ...
            getOrderByStatus$raw == null ? null : EnumWithDefaultValue_getOrderByStatus.fromJson(getOrderByStatus$raw, context)
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    static EnumWithDefaultValue_getOrderByStatus fromJson(JsonObject data, ShalomContext? context) {
