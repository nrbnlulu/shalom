...
class EnumRequiredNode extends Node {
  ...
  void updateStoreWithRaw(JsonObject raw, NodeManager manager) {
    ...
    _obj = EnumRequiredResponse.fromJson(raw);
  ...
  void updateWithJson(JsonObject newData) {
    ...
    if (_obj != null) {
      ...
      _obj = EnumRequiredResponse.fromJson(newData);
    }
    notifyListeners();
  }
  ...
  void setSubscription(JsonObject? data) {
    if (data != null) {
      _obj = EnumRequiredResponse.fromJson(data);
    }
    isSubscribed = true;
  }
