...
class EnumOptionalResponse {
    ...
    /// class members
        ...
        EnumOptional_updateOrderStatusOpt? updateOrderStatusOpt;
    ...
    static EnumOptionalResponse fromJson(JsonObject data, ShalomContext? context) {
        ...
        updateOrderStatusOpt_value = 
            ...
            updateOrderStatusOpt$raw == null ? null : EnumOptional_updateOrderStatusOpt.fromJson(updateOrderStatusOpt$raw, context)
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    static EnumOptional_updateOrderStatusOpt fromJson(JsonObject data, ShalomContext? context) {
