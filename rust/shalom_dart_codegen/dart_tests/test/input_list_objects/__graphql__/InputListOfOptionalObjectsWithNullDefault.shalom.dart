...
class InputListOfOptionalObjectsWithNullDefaultResponse{
    ...
    static InputListOfOptionalObjectsWithNullDefaultResponse fromJson(JsonObject data) {
            ...
            final InputListOfOptionalObjectsWithNullDefault_InputListOfOptionalObjectsWithNullDefault? InputListOfOptionalObjectsWithNullDefault_value;
            
                final JsonObject? InputListOfOptionalObjectsWithNullDefault$raw = data['InputListOfOptionalObjectsWithNullDefault']; 
                if (InputListOfOptionalObjectsWithNullDefault$raw != null) {
                    InputListOfOptionalObjectsWithNullDefault_value = InputListOfOptionalObjectsWithNullDefault_InputListOfOptionalObjectsWithNullDefault.fromJson(InputListOfOptionalObjectsWithNullDefault$raw);
                } else {
    ...
    InputListOfOptionalObjectsWithNullDefaultResponse updateWithJson(JsonObject data) {
        ...
        if (data.containsKey('InputListOfOptionalObjectsWithNullDefault')) {
            ...
            InputListOfOptionalObjectsWithNullDefault_value = InputListOfOptionalObjectsWithNullDefault;
        }
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    static InputListOfOptionalObjectsWithNullDefault_InputListOfOptionalObjectsWithNullDefault fromJson(JsonObject data) {
    ...
    InputListOfOptionalObjectsWithNullDefault_InputListOfOptionalObjectsWithNullDefault updateWithJson(JsonObject data) {
