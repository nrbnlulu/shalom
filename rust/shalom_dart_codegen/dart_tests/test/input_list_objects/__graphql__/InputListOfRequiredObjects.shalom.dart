...
class InputListOfRequiredObjectsResponse{
    ...
    static InputListOfRequiredObjectsResponse fromJson(JsonObject data) {
            ...
            final InputListOfRequiredObjects_InputListOfRequiredObjects? InputListOfRequiredObjects_value;
                ...
                final JsonObject? InputListOfRequiredObjects$raw = data['InputListOfRequiredObjects']; 
                if (InputListOfRequiredObjects$raw != null) {
                    InputListOfRequiredObjects_value = InputListOfRequiredObjects_InputListOfRequiredObjects.fromJson(InputListOfRequiredObjects$raw);
                } else {
    ...
    return {
        ...
        'InputListOfRequiredObjects':
                ...
                InputListOfRequiredObjects?.toJson()
