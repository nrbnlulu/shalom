...
class InputObjectContainingListOfObjectsResponse{
    ...
    static InputObjectContainingListOfObjectsResponse fromJson(JsonObject data) {
            ...
            final InputObjectContainingListOfObjects_InputObjectContainingListOfObjects? InputObjectContainingListOfObjects_value;
                ...
                final JsonObject? InputObjectContainingListOfObjects$raw = data['InputObjectContainingListOfObjects']; 
                if (InputObjectContainingListOfObjects$raw != null) {
                    InputObjectContainingListOfObjects_value = InputObjectContainingListOfObjects_InputObjectContainingListOfObjects.fromJson(InputObjectContainingListOfObjects$raw);
                } else {
