...
class InputListObjectsMAybeResponse {
    ...
    static InputListObjectsMAybeResponse fromJson(JsonObject data, ShalomContext? context) {
        ...
        InputListObjectsMAybe_value = 
                ...
                InputListObjectsMAybe$raw == null ? null : InputListObjectsMAybe_InputListObjectsMAybe.fromJson(InputListObjectsMAybe$raw, context)
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    static InputListObjectsMAybe_InputListObjectsMAybe fromJson(JsonObject data, ShalomContext? context) {
