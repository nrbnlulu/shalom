...
void main() {
  group('Simple Scalars Deserialize', () {
    ...
    test('idField', () {
      final result = GetIDResponse.fromJson({'idField': 'testID'});
    ...
    test('FloatOptional', () {
      final result = GetFloatOptionalResponse.fromJson({
        'floatOptional': 4.56,
      });
  ...
  group('Scalars Equality', () {
    ...
    test('StringOptional ==', () {
      final a = GetStringOptionalResponse.fromJson({
        'stringOptional': 'test',
      });
      final b = GetStringOptionalResponse.fromJson({
        'stringOptional': 'test',
      });
      expect(a == b, true);
      final c = GetStringOptionalResponse.fromJson({
        'stringOptional': null,
      });
      expect(a == c, false);
    });
    ...
    test('ID ==', () {
      final a = GetIDResponse.fromJson({'idField': 'test'});
      final b = GetIDResponse.fromJson({'idField': 'test'});
      expect(a == b, true);
      final c = GetIDResponse.fromJson({'idField': 'other'});
      expect(a == c, false);
    });
    ...
    test('BooleanOptional ==', () {
      final a = GetBooleanOptionalResponse.fromJson({
        'booleanOptional': true,
      });
      final b = GetBooleanOptionalResponse.fromJson({
        'booleanOptional': true,
      });
      expect(a == b, true);
      final c = GetBooleanOptionalResponse.fromJson({
        'booleanOptional': null,
      });
      expect(a == c, false);
    });
