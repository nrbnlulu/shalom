...
class GetIDOptionalResponse{
    ...
    static GetIDOptionalResponse fromJsonImpl(NormalizedRecordData data, ShalomCtx ctx) {
            ...
            final String? idOptional$value = 
                ...
                idOptional$raw as String?
            
        
    
;
        return GetIDOptionalResponse(
            idOptional: idOptional$value,
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    static GetIDOptional fromJsonImpl(NormalizedRecordData data, ShalomCtx ctx) {
