...
class GetStringOptionalResponse {
  ...
  static void normalize$inCache(JsonObject data, CacheUpdateContext ctx) {
    // TODO: arguments
    final RecordID this$fieldName = "GetStringOptional";
    ...
    final stringOptional$cached =
        this$NormalizedRecord[stringOptionalNormalized$Key];
  ...
  static GetStringOptionalResponse fromJsonImpl(
    NormalizedRecordData data,
    ShalomCtx ctx,
  ) {
    final stringOptional$raw = data["stringOptional"];
    final String? stringOptional$value = stringOptional$raw as String?;
    return GetStringOptionalResponse(stringOptional: stringOptional$value);
  }
...
class GetStringOptional {
  ...
  static GetStringOptional fromJsonImpl(
    NormalizedRecordData data,
    ShalomCtx ctx,
  ) {
    final stringOptional$raw = data["stringOptional"];
    final String? stringOptional$value = stringOptional$raw as String?;
    return GetStringOptional(stringOptional: stringOptional$value);
  }
