...
class GetFloatOptionalResponse{
    ...
    static GetFloatOptionalResponse fromJsonImpl(NormalizedRecordData data, ShalomCtx ctx) {
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    static GetFloatOptional fromJsonImpl(NormalizedRecordData data, ShalomCtx ctx) {
