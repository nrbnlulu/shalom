...
class GetBooleanOptionalResponse{
    ...
    static GetBooleanOptionalResponse fromJsonImpl(NormalizedRecordData data, ShalomCtx ctx) {
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    static GetBooleanOptional fromJsonImpl(NormalizedRecordData data, ShalomCtx ctx) {
