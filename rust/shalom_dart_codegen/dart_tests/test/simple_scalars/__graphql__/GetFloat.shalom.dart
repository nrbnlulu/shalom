...
class GetFloatResponse {
  ...
  static void normalize$inCache(JsonObject data, CacheUpdateContext ctx) {
    // TODO: arguments
    final RecordID this$fieldName = "GetFloat";
  ...
  static GetFloatResponse fromJsonImpl(
    NormalizedRecordData data,
    ShalomCtx ctx,
  ) {
    final float$raw = data["float"];
    final double float$value = float$raw as double;
    return GetFloatResponse(float: float$value);
  }
...
class GetFloat {
  ...
  static GetFloat fromJsonImpl(NormalizedRecordData data, ShalomCtx ctx) {
    final float$raw = data["float"];
    final double float$value = float$raw as double;
    return GetFloat(float: float$value);
  }
