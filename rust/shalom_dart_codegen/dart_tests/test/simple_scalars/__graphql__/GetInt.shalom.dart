...
class GetIntResponse {
  ...
  static GetIntResponse fromJsonImpl(JsonObject data, ShalomCtx ctx) {
    final intField$raw = data["intField"];
    final int intField$value = intField$raw as int;
    return GetIntResponse(intField: intField$value);
  }
...
class GetInt {
  ...
  static GetInt fromJsonImpl(JsonObject data, ShalomCtx ctx) {
    final intField$raw = data["intField"];
    final int intField$value = intField$raw as int;
    return GetInt(intField: intField$value);
  }
