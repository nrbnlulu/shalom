...
class GetMultipleFieldsResponse{
    ...
    static GetMultipleFieldsResponse fromJsonImpl(NormalizedRecordData data, ShalomCtx ctx) {
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    static GetMultipleFields fromJsonImpl(NormalizedRecordData data, ShalomCtx ctx) {
