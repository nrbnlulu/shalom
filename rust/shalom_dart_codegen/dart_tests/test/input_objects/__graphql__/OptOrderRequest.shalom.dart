...
class OptOrderRequestResponse {
    ...
    static OptOrderRequestResponse fromJson(JsonObject data, ShalomContext? context) {
        ...
        optOrderRequest_value = 
                ...
                optOrderRequest$raw == null ? null : OptOrderRequest_optOrderRequest.fromJson(optOrderRequest$raw, context)
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    static OptOrderRequest_optOrderRequest fromJson(JsonObject data, ShalomContext? context) {
