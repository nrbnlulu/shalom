...
class OrderRequestResponse {
    ...
    /// class members
        ...
        OrderRequest_orderRequest? orderRequest;
    ...
    static OrderRequestResponse fromJson(JsonObject data, ShalomContext? context) {
        ...
        orderRequest_value = 
            ...
            orderRequest$raw == null ? null : OrderRequest_orderRequest.fromJson(orderRequest$raw, context)
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    static OrderRequest_orderRequest fromJson(JsonObject data, ShalomContext? context) {
