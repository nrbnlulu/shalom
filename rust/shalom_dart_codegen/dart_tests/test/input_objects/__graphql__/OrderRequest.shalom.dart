...
class OrderRequestNode extends Node {
  OrderRequestResponse? _obj;
  OrderRequestNode({required super.id});

  @override 
  void updateStoreWithRaw(JsonObject raw, NodeManager manager) {
    _obj = OrderRequestResponse.fromJson(raw);
  ...
  void updateWithJson(JsonObject newData) {
    if (_obj != null) {
        ...
        _obj = OrderRequestResponse.fromJson(newData);
    }
    notifyListeners();
  }
  ...
  void setObj(JsonObject? data) {
     if (data != null) {
        _obj = OrderRequestResponse.fromJson(data);
     }
  }
