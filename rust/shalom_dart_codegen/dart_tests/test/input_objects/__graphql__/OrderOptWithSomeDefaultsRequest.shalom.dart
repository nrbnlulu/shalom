...
class OrderOptWithSomeDefaultsRequestResponse {
    ...
    static OrderOptWithSomeDefaultsRequestResponse fromJson(JsonObject data) {
        ...
        orderOptWithSomeDefaultsRequest_value = 
            ...
            orderOptWithSomeDefaultsRequest$raw == null ? null : OrderOptWithSomeDefaultsRequest_orderOptWithSomeDefaultsRequest.fromJson(orderOptWithSomeDefaultsRequest$raw)
