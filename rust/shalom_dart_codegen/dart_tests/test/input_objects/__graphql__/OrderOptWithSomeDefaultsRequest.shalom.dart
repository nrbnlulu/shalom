...
class OrderOptWithSomeDefaultsRequestResponse{
    ...
    /// class members
            ...
            final String orderOptWithSomeDefaultsRequest_id;   
...
class OrderOptWithSomeDefaultsRequestNode extends Node {
  OrderOptWithSomeDefaultsRequestResponse? obj = null;
  OrderOptWithSomeDefaultsRequestNode({required super.id});

  @override 
  void updateStoreWithRaw(JsonObject raw, NodeManager manager) {
     if (obj != null) {
      obj = OrderOptWithSomeDefaultsRequestResponse.fromJson(raw);
  ...
  void convertToObjAndSet(JsonObject data) {
     obj = OrderOptWithSomeDefaultsRequestResponse.fromJson(data);
  }
