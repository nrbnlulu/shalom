...
class OrderOptWithNullDefaultsRequestResponse{
    ...
    /// class members
            ...
            final String orderOptWithNullDefaultsRequest_id;   
...
class OrderOptWithNullDefaultsRequestNode extends Node {
  OrderOptWithNullDefaultsRequestResponse? obj = null;
  OrderOptWithNullDefaultsRequestNode({required super.id});

  @override 
  void updateStoreWithRaw(JsonObject raw, NodeManager manager) {
     if (obj != null) {
      obj = OrderOptWithNullDefaultsRequestResponse.fromJson(raw);
  ...
  void convertToObjAndSet(JsonObject data) {
     obj = OrderOptWithNullDefaultsRequestResponse.fromJson(data);
  }
