...
class GetListinOptWithUserOptNode extends Node {
  GetListinOptWithUserOptResponse? obj = null;
  GetListinOptWithUserOptNode({required super.id});

  @override 
  void updateStoreWithRaw(JsonObject raw, NodeManager manager) {
     if (obj != null) {
      obj = GetListinOptWithUserOptResponse.fromJson(raw);
  ...
  void convertToObjAndSet(JsonObject data) {
     obj = GetListinOptWithUserOptResponse.fromJson(data);
  }
