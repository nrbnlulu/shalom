...
class RequestGetListingWithUser extends Requestable {
  final GetListingWithUserResponse operation;
  final GetListingWithUserVariables variables;

  RequestGetListingWithUser({required this.operation, required this.variables});
  ...
  String queryString() {
    ...
    String variablesString = variables
        ...
        .join(", ");
    String queryString =
        "query GetListingWithUser($variablesString) $selectionString";
    return queryString;
  }
