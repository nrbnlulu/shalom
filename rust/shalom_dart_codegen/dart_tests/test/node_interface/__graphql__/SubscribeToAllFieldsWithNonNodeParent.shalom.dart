...
class SubscribeToAllFieldsWithNonNodeParentResponse {
  ...
  SubscribeToAllFieldsWithNonNodeParentResponse({this.userInfoNotNode});
  static SubscribeToAllFieldsWithNonNodeParentResponse fromJson(
    JsonObject data,
  ) {
    final SubscribeToAllFieldsWithNonNodeParent_userInfoNotNode?
    userInfoNotNode_value;
    final userInfoNotNode$raw = data["userInfoNotNode"];
    userInfoNotNode_value =
        userInfoNotNode$raw == null
            ? null
            : SubscribeToAllFieldsWithNonNodeParent_userInfoNotNode.fromJson(
              userInfoNotNode$raw,
            );
  ...
  static SubscribeToAllFieldsWithNonNodeParentResponse deserialize(
    JsonObject data,
    ShalomContext context,
  ) {
    final self = SubscribeToAllFieldsWithNonNodeParentResponse.fromJson(data);
...
class SubscribeToAllFieldsWithNonNodeParent_userInfoNotNode {
  ...
  // keywordargs constructor
  SubscribeToAllFieldsWithNonNodeParent_userInfoNotNode({required this.user});
  static SubscribeToAllFieldsWithNonNodeParent_userInfoNotNode fromJson(
    JsonObject data,
  ) {
    final SubscribeToAllFieldsWithNonNodeParent_userInfoNotNode_user user_value;
    final user$raw = data["user"];
    user_value =
        SubscribeToAllFieldsWithNonNodeParent_userInfoNotNode_user.fromJson(
          user$raw,
        );
  ...
  static SubscribeToAllFieldsWithNonNodeParent_userInfoNotNode deserialize(
    JsonObject data,
    ShalomContext context,
  ) {
    final self = SubscribeToAllFieldsWithNonNodeParent_userInfoNotNode.fromJson(
      data,
    );

    SubscribeToAllFieldsWithNonNodeParent_userInfoNotNode_user.deserialize(
      data['user'],
      context,
    );
...
class SubscribeToAllFieldsWithNonNodeParent_userInfoNotNode_user extends Node {
  ...
  static SubscribeToAllFieldsWithNonNodeParent_userInfoNotNode_user fromJson(
    JsonObject data,
  ) {
  ...
  static SubscribeToAllFieldsWithNonNodeParent_userInfoNotNode_user deserialize(
    JsonObject data,
    ShalomContext context,
  ) {
    final self =
