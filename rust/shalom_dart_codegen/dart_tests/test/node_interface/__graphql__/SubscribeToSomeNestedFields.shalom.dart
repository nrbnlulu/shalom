...
class SubscribeToSomeNestedFieldsResponse {
  ...
  static SubscribeToSomeNestedFieldsResponse fromJson(
    JsonObject data,
    ...
    userInfo_value =
        userInfo$raw == null
            ? null
            : SubscribeToSomeNestedFields_userInfo.fromJson(
              userInfo$raw,
              context,
            );
...
class SubscribeToSomeNestedFields_userInfo extends Node {
  ...
  static SubscribeToSomeNestedFields_userInfo fromJson(
    JsonObject data,
    ShalomContext? context,
  ) {
    ...
    user_value = SubscribeToSomeNestedFields_userInfo_user.fromJson(
      user$raw,
      context,
    );
  ...
  void updateWithJson(
    ...
    for (final fieldName in changedFields) {
      switch (fieldName) {
        ...
        case 'user':
          user = SubscribeToSomeNestedFields_userInfo_user.fromJson(
            rawData['user'],
            context,
          );
        ...
        case 'address':
          address = SubscribeToSomeNestedFields_userInfo_address.fromJson(
            rawData['address'],
            context,
          );
...
class SubscribeToSomeNestedFields_userInfo_order {
  ...
  static SubscribeToSomeNestedFields_userInfo_order fromJson(
    JsonObject data,
    ShalomContext? context,
  ) {
...
class SubscribeToSomeNestedFields_userInfo_user extends Node {
  ...
  static SubscribeToSomeNestedFields_userInfo_user fromJson(
    JsonObject data,
    ShalomContext? context,
  ) {
    final String id_value;
