...
class SubscribeToSomeFieldsWithNonNodeParentResponse {
    ...
    /// class members
        ...
        final SubscribeToSomeFieldsWithNonNodeParent_userInfoNotNode? userInfoNotNode;
    
    // keywordargs constructor
    SubscribeToSomeFieldsWithNonNodeParentResponse({
    
        this.userInfoNotNode,
    
    });
    static SubscribeToSomeFieldsWithNonNodeParentResponse fromJson(JsonObject data, ShalomContext? context) {
    
        
        final SubscribeToSomeFieldsWithNonNodeParent_userInfoNotNode? userInfoNotNode_value;
        final userInfoNotNode$raw = data["userInfoNotNode"];
        userInfoNotNode_value = 
    
           
            
                userInfoNotNode$raw == null ? null : SubscribeToSomeFieldsWithNonNodeParent_userInfoNotNode.fromJson(userInfoNotNode$raw, context)
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    /// class members
        ...
        final SubscribeToSomeFieldsWithNonNodeParent_userInfoNotNode_user user;
    
    // keywordargs constructor
    SubscribeToSomeFieldsWithNonNodeParent_userInfoNotNode({
    required
        this.user,
    
    });
    static SubscribeToSomeFieldsWithNonNodeParent_userInfoNotNode fromJson(JsonObject data, ShalomContext? context) {
    
        
        final SubscribeToSomeFieldsWithNonNodeParent_userInfoNotNode_user user_value;
        ...
        user_value = 
            ...
            if (context != null) {
                    ...
                    SubscribeToSomeFieldsWithNonNodeParent_userInfoNotNode_user.deserialize(user$raw, context)
...
;
    ...
    static SubscribeToSomeFieldsWithNonNodeParent_userInfoNotNode_user fromJson(JsonObject data, ShalomContext? context) {
...
;
    ...
    return SubscribeToSomeFieldsWithNonNodeParent_userInfoNotNode_user(
        ...
        static SubscribeToSomeFieldsWithNonNodeParent_userInfoNotNode_user deserialize(JsonObject data, ShalomContext context) {
            final self = SubscribeToSomeFieldsWithNonNodeParent_userInfoNotNode_user.fromJson(data); 
