...
class SubscribeToSomeFieldsWithNonNodeParentResponse {
  ...
  static SubscribeToSomeFieldsWithNonNodeParentResponse deserialize(
    JsonObject data,
    ShalomContext context,
  ) {
    final self = SubscribeToSomeFieldsWithNonNodeParentResponse.fromJson(data);
...
class SubscribeToSomeFieldsWithNonNodeParent_userInfoNotNode {
  ...
  static SubscribeToSomeFieldsWithNonNodeParent_userInfoNotNode deserialize(
    JsonObject data,
    ShalomContext context,
  ) {
    final self =
        SubscribeToSomeFieldsWithNonNodeParent_userInfoNotNode.fromJson(data);

    SubscribeToSomeFieldsWithNonNodeParent_userInfoNotNode_user.deserialize(
      data['user'],
      context,
    );
...
class SubscribeToSomeFieldsWithNonNodeParent_userInfoNotNode_user extends Node {
  ...
  static SubscribeToSomeFieldsWithNonNodeParent_userInfoNotNode_user
