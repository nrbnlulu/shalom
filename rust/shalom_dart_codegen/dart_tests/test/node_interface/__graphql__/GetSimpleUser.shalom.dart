...
class GetSimpleUserResponse {
  ...
  GetSimpleUserResponse({this.user});
  static GetSimpleUserResponse fromJson(
    JsonObject data, {
    ...
    user_value =
        user$raw == null
            ? null
            : GetSimpleUser_user.fromJson(user$raw, context: context);

    return GetSimpleUserResponse(user: user_value);
  }

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other is GetSimpleUserResponse && other.user == user);
  }
...
class RequestGetSimpleUser extends Requestable {
  ...
  RequestGetSimpleUser({required this.variables});
...
class GetSimpleUserVariables {
  ...
  GetSimpleUserVariables({required this.userId});
  ...
  GetSimpleUserVariables updateWith({String? userId}) {
    ...
    return GetSimpleUserVariables(userId: userId$next);
  }
}
