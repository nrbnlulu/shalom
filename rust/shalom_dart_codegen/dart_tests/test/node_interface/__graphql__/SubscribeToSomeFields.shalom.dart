...
class SubscribeToSomeFieldsResponse {
    ...
    /// class members
        ...
        SubscribeToSomeFields_user? user;
    ...
    static SubscribeToSomeFieldsResponse fromJson(JsonObject data, ShalomContext? context) {
        ...
        user_value = 
            ...
            user$raw == null ? null : SubscribeToSomeFields_user.fromJson(user$raw, context)
...
// ------------ OBJECT DEFINITIONS -------------
    ...
    static SubscribeToSomeFields_user fromJson(JsonObject data, ShalomContext? context) {
