...
class SubscribeToAllNestedFieldsResponse {
    ...
    static SubscribeToAllNestedFieldsResponse fromJson(JsonObject data, ShalomContext? context) {
        ...
        userInfo_value = 
            ...
            userInfo$raw == null ? null : SubscribeToAllNestedFields_userInfo.fromJson(userInfo$raw, context)
...
;
        ...
        user_value = 
            ...
            SubscribeToAllNestedFields_userInfo_user.fromJson(user$raw, context)
...
;
        ...
        address_value = 
            ...
            SubscribeToAllNestedFields_userInfo_address.fromJson(address$raw, context)
            ...
            for (final fieldName in changedFields) {
                switch (fieldName) {
                         ...
                         case 'user':
                                ...
                                user = SubscribeToAllNestedFields_userInfo_user.fromJson(rawData['user'], context); 
                         ...
                         case 'address':
                                ...
                                address = SubscribeToAllNestedFields_userInfo_address.fromJson(rawData['address'], context); 
