    ...
    static SubscribeToAllFieldsResponse fromJson(JsonObject data, ShalomContext? context) {
        ...
        user_value = 
            ...
            if (context != null) {
                    ...
                    user$raw == null ? null : SubscribeToAllFields_user.deserialize(user$raw, context)
...
;
    ...
    return SubscribeToAllFields_user(
        ...
        static SubscribeToAllFields_user deserialize(JsonObject data, ShalomContext context) {
