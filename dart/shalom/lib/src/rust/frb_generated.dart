...
import 'package:flutter_rust_bridge/flutter_rust_bridge_for_generated.dart';
                ...
                abstract class RustLibApi extends BaseApi {
                  void crateApiRuntimeCompleteTransport({required RuntimeHandle handle , required BigInt requestId });
...
void crateApiRuntimePushResponse({required RuntimeHandle handle , required BigInt requestId , required String responseJson });

void crateApiRuntimePushTransportError({required RuntimeHandle handle , required BigInt requestId , required String message , required String code , String? detailsJson });
...
BigInt crateApiRuntimeWriteOptimistic({required RuntimeHandle handle , required String opName , required String dataJson });
...
CrossPlatformFinalizerArg get rust_arc_decrement_strong_count_WsSansIoPtr;
                ...
                class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
                  ...
                  @override void crateApiRuntimeCompleteTransport({required RuntimeHandle handle , required BigInt requestId })  { return handler.executeSync(SyncTask(
            callFfi: () {
...
@override void crateApiRuntimePushResponse({required RuntimeHandle handle , required BigInt requestId , required String responseJson })  { return handler.executeSync(SyncTask(
            callFfi: () {
...
@override void crateApiRuntimePushTransportError({required RuntimeHandle handle , required BigInt requestId , required String message , required String code , String? detailsJson })  { return handler.executeSync(SyncTask(
            callFfi: () {
...
@override BigInt crateApiRuntimeWriteOptimistic({required RuntimeHandle handle , required String opName , required String dataJson })  { return handler.executeSync(SyncTask(
            callFfi: () {
...
final arr = raw as List<dynamic>;
                if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
                return RuntimeConfigInput(gcIntervalMs: dco_decode_opt_box_autoadd_u_64(arr[0]),
...
return RuntimeConfigInput(gcIntervalMs: var_gcIntervalMs, retentionGraceMs: var_retentionGraceMs); }
