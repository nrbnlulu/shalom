...
Future<RuntimeHandle> crateApiRuntimeInitRuntime({required String schemaSdl , required List<String> fragmentSdls , String? configJson });

BigInt crateApiRuntimeInitSubscription({required RuntimeHandle handle , required String targetId , String? rootRef , required List<String> refs });

Stream<String> crateApiRuntimeListenRequests({required RuntimeHandle handle });

Stream<String> crateApiRuntimeListenSubscription({required RuntimeHandle handle , required BigInt subscriptionId });
...
Stream<String> crateApiRuntimeRequestOp({required RuntimeHandle handle , required String operation , String? variablesJson , required NetworkPolicy networkPolicy });
...
@override Future<RuntimeHandle> crateApiRuntimeInitRuntime({required String schemaSdl , required List<String> fragmentSdls , String? configJson })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
...
@override BigInt crateApiRuntimeInitSubscription({required RuntimeHandle handle , required String targetId , String? rootRef , required List<String> refs })  { return handler.executeSync(SyncTask(
            callFfi: () {
...
sse_encode_list_String(refs, serializer);
        ...
        TaskConstMeta get kCrateApiRuntimeInitSubscriptionConstMeta => const TaskConstMeta(
...
@override Stream<String> crateApiRuntimeListenSubscription({required RuntimeHandle handle , required BigInt subscriptionId })  { 
            final sink = RustStreamSink<String>();
            unawaited(handler.executeNormal(NormalTask(
            callFfi: (port_) {
...
@override Stream<String> crateApiRuntimeRequestOp({required RuntimeHandle handle , required String operation , String? variablesJson , required NetworkPolicy networkPolicy })  { 
            final sink = RustStreamSink<String>();
            unawaited(handler.executeNormal(NormalTask(
            callFfi: (port_) {
...
@protected NetworkPolicy dco_decode_network_policy(dynamic raw){ // Codec=Dco (DartCObject based), see doc to use other codecs
...
@protected NetworkPolicy sse_decode_network_policy(SseDeserializer deserializer){ // Codec=Sse (Serialization based), see doc to use other codecs
...
@protected void sse_encode_network_policy(NetworkPolicy self, SseSerializer serializer){ // Codec=Sse (Serialization based), see doc to use other codecs
