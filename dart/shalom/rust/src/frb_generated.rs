    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                ...
                let output_ok =
                    Ok::<_, ()>(crate::api::ws::ws_active_operation_ids(&*api_sansio_guard))?;
                std::result::Result::Ok(output_ok)
            })())
        },
    )
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                ...
                let output_ok = Ok::<_, ()>(crate::api::ws::ws_complete_frame(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                ...
                let api_sansio_guard = api_sansio_guard.unwrap();
                let output_ok =
                    Ok::<_, ()>(crate::api::ws::ws_connection_init_frame(&*api_sansio_guard))?;
                std::result::Result::Ok(output_ok)
            })())
        },
    )
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                ...
                let api_sansio_guard = api_sansio_guard.unwrap();
                let output_ok = Ok::<_, ()>(crate::api::ws::ws_is_connected(&*api_sansio_guard))?;
                std::result::Result::Ok(output_ok)
            })())
        },
    )
...
fn wire__crate__api__ws__ws_ping_frame_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse::<_, ()>((move || {
                let output_ok = Ok::<_, ()>(crate::api::ws::ws_ping_frame())?;
                std::result::Result::Ok(output_ok)
            })())
        },
    )
