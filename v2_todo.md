...
- [x] flutter tests => a simple flutter project that uses the `@Query` / `@Fragment` / `Subscription` codegen api's (currently passing) 
- [ ] flutter tests => Mutation and Subscription
