...
- `@observe` - a graphql directive that the codegen (and the runtime) use to mark that an operation / fragment can subscribe to normalized cache updates. (works for both Dart and Flutter)
