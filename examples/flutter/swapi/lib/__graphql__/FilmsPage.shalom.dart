...
class FilmsPageResponse   {
    ...
    static FilmsPageResponse fromJson(shalom_core.JsonObject data) {
     ...
     allFilms$value = 
        ...
        FilmsPage_allFilms.fromJson(data['allFilms'] as shalom_core.JsonObject)
    
;
        return FilmsPageResponse(
    ...
    int get hashCode =>
        ...
        FilmsPage_allFilms.G__typename
        ]);
    ...
    static FilmsPage_allFilms fromJson(shalom_core.JsonObject data) {
     ...
     films$value = 
        ...
        (data['films'] as List<dynamic>).map((e) => 
            ...
            e == null ? null : FilmWidgetRef.fromInput(shalom_core.observedRefInputFromJson((e as shalom_core.JsonObject)[r'$FilmWidget'] as shalom_core.JsonObject))
        
    
).toList()
    
;
        return FilmsPage_allFilms(
...
;
    ...
    @override
    bool operator ==(Object other) {
        return identical(this, other) || (other is FilmsPageVariables
