...
extension type AlbumWidgetRef.fromInput(shalom_core.ObservedRefInput _inner) {
  ...
  static AlbumWidgetRef fromId(String id) => fromEntityKey(AlbumWidgetData.entityKey(id));

  
  shalom_core.ObservedRefInput get toInput => _inner;
  String get anchor => _inner.anchor;
  shalom_core.JsonObject toJson() => {'__shalom_observed_ref': {'observable_id': _inner.observableId, 'anchor': _inner.anchor}};
...
class AlbumWidget_gifs  implements
...
final class AlbumWidgetData implements AlbumWidget, shalom_core.FragmentInterface {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || (other is AlbumWidgetData
    && 
  ...
  static AlbumWidgetData fromCache(shalom_core.JsonObject data) {
    final List<AlbumWidget_gifs> gifs$value = 
        ...
        AlbumWidget_gifs.fromJson(e as shalom_core.JsonObject)
