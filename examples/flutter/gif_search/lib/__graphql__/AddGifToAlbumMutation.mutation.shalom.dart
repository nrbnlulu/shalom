...
abstract class $AddGifToAlbumMutation {
    ...
    Future<AddGifToAlbumMutationData> executeWithCacheUpdate({
        ...
        required String title,
        required String url,
        required void Function(CacheProxy cache, AddGifToAlbumMutationData data) update,
    }) async {
    ...
    Future<OptimisticMutationResponse<AddGifToAlbumMutationData>> executeOptimistic(
        AddGifToAlbumMutationData Function(AddGifToAlbumMutationVariables vars) optimisticFactory, {
