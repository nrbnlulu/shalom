...
class AlbumGifSearchResponse   {
    ...
    bool operator ==(Object other) {
        return identical(this, other) ||
            ...
            (other is AlbumGifSearchResponse &&
                    
    
        
            searchGifs == other.searchGifs
    ...
    int get hashCode =>
        ...
        AlbumGifSearchResponse.G__typename
        ]);
    ...
    static AlbumGifSearchResponse fromJson(shalom_core.JsonObject data) {
     ...
     searchGifs$value = 
        ...
        AlbumGifSearch_searchGifs.fromJson(data['searchGifs'] as shalom_core.JsonObject)
    
;
        return AlbumGifSearchResponse(
            
                    searchGifs: searchGifs$value,
    ...
    final 
        ...
        List<AlbumGifSearch_searchGifs_items>
...
;
     ...
     items$value = 
        ...
        AlbumGifSearch_searchGifs_items.fromJson(e as shalom_core.JsonObject)
...
;
    ...
    @override
    bool operator ==(Object other) {
        return identical(this, other) || (other is AlbumGifSearchVariables
