...
abstract class $AlbumGifSearch extends StatefulWidget {
    ...
    final shalom_core.ExecutionPolicyInput executionPolicy;
        ...
        const $AlbumGifSearch({super.key, required this.variables, this.executionPolicy = .cacheFirst});
...
class _$AlbumGifSearchState extends State<$AlbumGifSearch> {
    ...
    void didUpdateWidget(covariant $AlbumGifSearch oldWidget) {
        ...
        if (widget.executionPolicy != oldWidget.executionPolicy || widget.variables != oldWidget.variables) {
            _subscribe();
        }
    }
    ...
    void _subscribe() {
        ...
        _sub = AlbumGifSearchObservable(
            ...
            .listen(
                ...
                onDone: () {
                    debugPrint('[widget] AlbumGifSearch.onDone fired, mounted=$mounted');
