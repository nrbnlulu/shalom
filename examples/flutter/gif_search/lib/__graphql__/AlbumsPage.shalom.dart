...
class AlbumsPageResponse   {
    ...
    int get hashCode =>
        ...
        AlbumsPageResponse.G__typename
        ]);
    ...
    static AlbumsPageResponse fromJson(shalom_core.JsonObject data) {
     ...
     albums$value = 
            ...
            (data['albums'] as List<dynamic>).map((e) => 
    
        
        
            AlbumWidgetRef.fromInput(shalom_core.observedRefInputFromJson((e as shalom_core.JsonObject)[r'$AlbumWidget'] as shalom_core.JsonObject))
 ...
 &&
    ...
    static AlbumsPage_albums fromJson(shalom_core.JsonObject data) {
     ...
     gifs$value = 
            ...
            AlbumGifRef.fromInput(shalom_core.observedRefInputFromJson((e as shalom_core.JsonObject)[r'$AlbumGif'] as shalom_core.JsonObject))
