...
class CharacterCard_image   {
    ...
    static void normalize$inCache(shalom_core.JsonObject data,
            ...
            if (this$normalizedID_temp == null) {
                this$normalizedID = "${parent$normalizedID}.${this$fieldName}";
                    ...
                    final normalized$objRecord = shalom_core.NormalizedObjectRecord(typename: "CharacterImage", id: this$normalizedID_temp!);
    ...
    static CharacterCard_image fromCached(shalom_core.NormalizedRecordData data, shalom_core.ShalomCtx ctx) {
    final large$raw = data["large"];
...
;
    ...
    int get hashCode =>
        ...
        CharacterCard_image.G__typename
        ]);
...
class CharacterCard_name   {
    ...
    static void normalize$inCache(shalom_core.JsonObject data,
            ...
            if (this$normalizedID_temp == null) {
                this$normalizedID = "${parent$normalizedID}.${this$fieldName}";
                    ...
                    final normalized$objRecord = shalom_core.NormalizedObjectRecord(typename: "CharacterName", id: this$normalizedID_temp!);
                    if (this$cached != null && this$cached is shalom_core.NormalizedObjectRecord && this$cached as shalom_core.NormalizedObjectRecord != normalized$objRecord){
                        ctx.addChangedRecord("${parent$normalizedID}.${this$fieldName}");
                    }
                    parent$record[this$fieldName] = normalized$objRecord;
    ...
    static CharacterCard_name fromCached(shalom_core.NormalizedRecordData data, shalom_core.ShalomCtx ctx) {
    final full$raw = data["full"];
            final String? full$value = 
...
;
    ...
    int get hashCode =>
        ...
        CharacterCard_name.G__typename
        ]);
