...
class AiringScheduleInput {
  ...
  AiringScheduleInput updateWith({
    shalom_core.Maybe<shalom_core.Maybe<int?>> airingAt =
        const shalom_core.None(),
    shalom_core.Maybe<shalom_core.Maybe<int?>> episode =
        const shalom_core.None(),
    shalom_core.Maybe<shalom_core.Maybe<int?>> timeUntilAiring =
        const shalom_core.None(),
  }) {
    ...
    return AiringScheduleInput(
      airingAt: airingAt$next.isSome()
          ? shalom_core.Some(airingAt$next.some())
          : const shalom_core.None(),

      episode: episode$next.isSome()
          ? shalom_core.Some(episode$next.some())
          : const shalom_core.None(),

      timeUntilAiring: timeUntilAiring$next.isSome()
          ? shalom_core.Some(timeUntilAiring$next.some())
          : const shalom_core.None(),
    );
  }
}
...
class AniChartHighlightInput {
  ...
  AniChartHighlightInput updateWith({
    shalom_core.Maybe<shalom_core.Maybe<String?>> highlight =
        const shalom_core.None(),
    shalom_core.Maybe<shalom_core.Maybe<int?>> mediaId =
        const shalom_core.None(),
  }) {
    ...
    return AniChartHighlightInput(
      highlight: highlight$next.isSome()
          ? shalom_core.Some(highlight$next.some())
          : const shalom_core.None(),

      mediaId: mediaId$next.isSome()
          ? shalom_core.Some(mediaId$next.some())
          : const shalom_core.None(),
    );
  }
}
...
class CharacterNameInput {
  ...
  shalom_core.JsonObject toJson() {
    ...
    if (alternative.isSome()) {
      ...
      data["alternative"] = value?.map((e) => e).toList();
    }
    if (alternativeSpoiler.isSome()) {
      final value = this.alternativeSpoiler.some();
      data["alternativeSpoiler"] = value?.map((e) => e).toList();
    }
    if (first.isSome()) {
  ...
  CharacterNameInput updateWith({
    shalom_core.Maybe<shalom_core.Maybe<List<String?>?>> alternative =
        const shalom_core.None(),
    shalom_core.Maybe<shalom_core.Maybe<List<String?>?>> alternativeSpoiler =
        const shalom_core.None(),
    shalom_core.Maybe<shalom_core.Maybe<String?>> first =
        const shalom_core.None(),
    shalom_core.Maybe<shalom_core.Maybe<String?>> last =
        const shalom_core.None(),
    shalom_core.Maybe<shalom_core.Maybe<String?>> middle =
        const shalom_core.None(),
    shalom_core.Maybe<shalom_core.Maybe<String?>> native =
        const shalom_core.None(),
  }) {
    ...
    return CharacterNameInput(
      alternative: alternative$next.isSome()
          ? shalom_core.Some(alternative$next.some())
          : const shalom_core.None(),

      alternativeSpoiler: alternativeSpoiler$next.isSome()
          ? shalom_core.Some(alternativeSpoiler$next.some())
          : const shalom_core.None(),

      first: first$next.isSome()
          ? shalom_core.Some(first$next.some())
          : const shalom_core.None(),

      last: last$next.isSome()
          ? shalom_core.Some(last$next.some())
          : const shalom_core.None(),

      middle: middle$next.isSome()
          ? shalom_core.Some(middle$next.some())
          : const shalom_core.None(),

      native: native$next.isSome()
          ? shalom_core.Some(native$next.some())
          : const shalom_core.None(),
    );
  }
}
...
class FuzzyDateInput {
  ...
  FuzzyDateInput updateWith({
    ...
    return FuzzyDateInput(
      day: day$next.isSome()
          ? shalom_core.Some(day$next.some())
          : const shalom_core.None(),

      month: month$next.isSome()
          ? shalom_core.Some(month$next.some())
          : const shalom_core.None(),

      year: year$next.isSome()
          ? shalom_core.Some(year$next.some())
          : const shalom_core.None(),
    );
  }
}
...
class ListActivityOptionInput {
  ...
  ListActivityOptionInput updateWith({
    shalom_core.Maybe<shalom_core.Maybe<bool?>> disabled =
        const shalom_core.None(),
    shalom_core.Maybe<shalom_core.Maybe<MediaListStatus?>> type =
        const shalom_core.None(),
  }) {
    ...
    return ListActivityOptionInput(
      disabled: disabled$next.isSome()
          ? shalom_core.Some(disabled$next.some())
          : const shalom_core.None(),

      type: type$next.isSome()
          ? shalom_core.Some(type$next.some())
          : const shalom_core.None(),
    );
  }
}
...
class MediaExternalLinkInput {
  ...
  MediaExternalLinkInput updateWith({int? id, String? site, String? url}) {
    ...
    return MediaExternalLinkInput(id: id$next, site: site$next, url: url$next);
  }
}
...
class MediaListOptionsInput {
  ...
  MediaListOptionsInput updateWith({
    shalom_core.Maybe<shalom_core.Maybe<List<String?>?>> advancedScoring =
        const shalom_core.None(),
    shalom_core.Maybe<shalom_core.Maybe<bool?>> advancedScoringEnabled =
        const shalom_core.None(),
    shalom_core.Maybe<shalom_core.Maybe<List<String?>?>> customLists =
        const shalom_core.None(),
    shalom_core.Maybe<shalom_core.Maybe<List<String?>?>> sectionOrder =
        const shalom_core.None(),
    shalom_core.Maybe<shalom_core.Maybe<bool?>> splitCompletedSectionByFormat =
        const shalom_core.None(),
    shalom_core.Maybe<shalom_core.Maybe<String?>> theme =
        const shalom_core.None(),
  }) {
    ...
    final splitCompletedSectionByFormat$next =
        switch (splitCompletedSectionByFormat) {
    ...
    return MediaListOptionsInput(
      advancedScoring: advancedScoring$next.isSome()
          ? shalom_core.Some(advancedScoring$next.some())
          : const shalom_core.None(),

      advancedScoringEnabled: advancedScoringEnabled$next.isSome()
          ? shalom_core.Some(advancedScoringEnabled$next.some())
          : const shalom_core.None(),

      customLists: customLists$next.isSome()
          ? shalom_core.Some(customLists$next.some())
          : const shalom_core.None(),

      sectionOrder: sectionOrder$next.isSome()
          ? shalom_core.Some(sectionOrder$next.some())
          : const shalom_core.None(),

      splitCompletedSectionByFormat: splitCompletedSectionByFormat$next.isSome()
          ? shalom_core.Some(splitCompletedSectionByFormat$next.some())
          : const shalom_core.None(),

      theme: theme$next.isSome()
          ? shalom_core.Some(theme$next.some())
          : const shalom_core.None(),
    );
  }
}
...
class MediaTitleInput {
  ...
  MediaTitleInput updateWith({
    ...
    shalom_core.Maybe<shalom_core.Maybe<String?>> native =
        const shalom_core.None(),
    shalom_core.Maybe<shalom_core.Maybe<String?>> romaji =
        const shalom_core.None(),
  }) {
    ...
    return MediaTitleInput(
      english: english$next.isSome()
          ? shalom_core.Some(english$next.some())
          : const shalom_core.None(),
      ...
      romaji: romaji$next.isSome()
          ? shalom_core.Some(romaji$next.some())
          : const shalom_core.None(),
    );
  }
}
...
class NotificationOptionInput {
  ...
  NotificationOptionInput updateWith({
    shalom_core.Maybe<shalom_core.Maybe<bool?>> enabled =
        const shalom_core.None(),
    shalom_core.Maybe<shalom_core.Maybe<NotificationType?>> type =
        const shalom_core.None(),
  }) {
    ...
    return NotificationOptionInput(
      enabled: enabled$next.isSome()
          ? shalom_core.Some(enabled$next.some())
          : const shalom_core.None(),
